...
def generate_launch_description():
    ...
    twist_mux_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            "cmd_vel_out": "bumperbot_controller/cmd_vel_unstamped", #where twist mux is going to publish
            "config_topics": os.path.join(bumperbot_controller_pkg,"config","twist_mux_topics.yaml"),#this is one source of the mux
    ...
    #twist relay node we implemented (it interface the joystick with the twist and also the controller with the twist node)
